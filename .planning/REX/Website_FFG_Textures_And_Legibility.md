...
1. **Speed:** Does it load fast on 3G? (Target: < 2s)
2. **Clarity:** Can users read body text at 140% zoom?
3. **Identity:** Do returning visitors recognize the Art Deco aesthetic?
